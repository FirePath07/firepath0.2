      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 transition-colors duration-300">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-gray-800 dark:text-white">Your Inputs</h2>
          ...
          <div className="space-y-5">
              ...
              <div className="relative group">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 flex items-center gap-1">
                  ...
                  <div className="relative inline-block">
                    ...
                    <div className="invisible group-hover:visible absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 bg-gray-800 dark:bg-gray-900 text-white text-xs rounded p-2 text-center z-10">
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg border border-gray-200 dark:border-gray-600 mt-4">
              <h4 className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2">Inflation Projection</h4>
              <div className="flex justify-between items-end">
                <div>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Expense Today</p>
                  <p className="font-semibold text-gray-900 dark:text-white">{formatIndianCurrency(annualExpensesToday)}</p>
                </div>
                <div className="text-gray-400 mb-1">➜</div>
                <div className="text-right">
                  <p className="text-xs text-gray-500 dark:text-gray-400">Expense at Age {retirementAge}</p>
                  <p className="font-bold text-purple-700 dark:text-purple-400">{formatIndianCurrency(expenseAtRetirement)}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          {/* Standard FIRE */}
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border-l-4 border-emerald-500 transform transition hover:scale-[1.01]">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">Standard FIRE Target</p>
                <h3 className="text-3xl font-extrabold text-gray-900 dark:text-white mt-1">{formatIndianCurrency(standardFireTarget)}</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">25x annual expenses at retirement</p>
              </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
              <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">Lean FIRE</p>
              <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mt-1">{formatIndianCurrency(leanFireTarget)}</h3>
              <p className="text-xs text-gray-400 mt-1">60% of Standard</p>
            </div>

            {/* Fat FIRE */}
            <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
              <p className="text-xs font-bold text-amber-600 dark:text-amber-500 uppercase">Fat FIRE</p>
              <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mt-1">{formatIndianCurrency(fatFireTarget)}</h3>
              <p className="text-xs text-gray-400 mt-1">200% of Standard</p>
            </div>
          </div>

          {/* Coast FIRE */}
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 p-6 rounded-xl border border-blue-100 dark:border-blue-800/50 shadow-sm relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-1">
                <p className="text-xs font-bold text-blue-800 dark:text-blue-300 uppercase tracking-widest">Coast FIRE Target</p>
              ...
              <h3 className="text-3xl font-extrabold text-blue-900 dark:text-blue-100 mt-1">{formatIndianCurrency(coastFireTarget)}</h3>
              <p className="text-sm text-blue-700 dark:text-blue-300 mt-2">
                Need to save by age <strong>{coastFireAge}</strong>
              </p>
              <div className="mt-3 text-xs text-blue-600/80 dark:text-blue-300/80 bg-blue-100/50 dark:bg-blue-800/50 p-2 rounded inline-block">
